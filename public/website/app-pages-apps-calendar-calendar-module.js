(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-pages-apps-calendar-calendar-module"],{
...
/***/ "./src/app/pages/apps/calendar/calendar-edit/calendar-edit.component.html":
/*!********************************************************************************!*\
  !*** ./src/app/pages/apps/calendar/calendar-edit/calendar-edit.component.html ***!
  \********************************************************************************/
/*! no static exports found */
...
var CalendarEditComponent = /** @class */ (function () {
    ...
    CalendarEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./calendar-edit.component.html */ "./src/app/pages/apps/calendar/calendar-edit/calendar-edit.component.html"),
            styles: [__webpack_require__(/*! ./calendar-edit.component.scss */ "./src/app/pages/apps/calendar/calendar-edit/calendar-edit.component.scss")]
        }),
...
/***/ "./src/app/pages/apps/calendar/calendar.component.html":
/*!*************************************************************!*\
  !*** ./src/app/pages/apps/calendar/calendar.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
/* harmony import */ var lodash_es_clone__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash-es/clone */ "./node_modules/lodash-es/clone.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _calendar_edit_calendar_edit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./calendar-edit/calendar-edit.component */ "./src/app/pages/apps/calendar/calendar-edit/calendar-edit.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CalendarComponent = /** @class */ (function () {
    function CalendarComponent(dialog, snackBar) {
        ...
        this.actions = [{
                ...
                onClick: function (_a) {
                    var event = _a.event;
                    var foundIndex = _this.events.indexOf(event);
                    if (foundIndex > -1) {
                        _this.events = _this.events.splice(foundIndex, 1);
                    }
                    _this.snackBar.open('Deleted Event: ' + event.title, 'UNDO', { duration: 3000 })
                        .onAction().subscribe(function () {
                        _this.events.splice(foundIndex, 0, event);
                    });
                }
            }];
        this.viewDate = new Date();
        this.events = [{
                start: moment__WEBPACK_IMPORTED_MODULE_3__().subtract(1, 'days').toDate(),
                end: moment__WEBPACK_IMPORTED_MODULE_3__().add(1, 'days').toDate(),
                title: 'A 3 day event',
                color: {
                    primary: '#009688',
                    secondary: '#80CBC4'
                ...
                start: moment__WEBPACK_IMPORTED_MODULE_3__().toDate(),
                end: moment__WEBPACK_IMPORTED_MODULE_3__().toDate(),
                ...
                start: moment__WEBPACK_IMPORTED_MODULE_3__().add(9, 'days').toDate(),
                end: moment__WEBPACK_IMPORTED_MODULE_3__().add(9, 'days').add(1, 'week').toDate(),
                ...
                start: moment__WEBPACK_IMPORTED_MODULE_3__().subtract(2, 'hours').toDate(),
                end: moment__WEBPACK_IMPORTED_MODULE_3__().toDate(),
    ...
    CalendarComponent.prototype.handleEvent = function (action, event) {
        var _this = this;
        var eventCopy = Object(lodash_es_clone__WEBPACK_IMPORTED_MODULE_2__["default"])(event);
        console.log(event);
        var dialogRef = this.dialog.open(_calendar_edit_calendar_edit_component__WEBPACK_IMPORTED_MODULE_5__["CalendarEditComponent"], {
            data: event
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                event = result;
                _this.snackBar.open('Changed Event: ' + event.title, 'UNDO')
                    .onAction().subscribe(function () {
                    event = eventCopy;
                    _this.refresh.next();
                });
    ...
    CalendarComponent.prototype.dayClicked = function (_a) {
        ...
        if (moment__WEBPACK_IMPORTED_MODULE_3__(this.viewDate).isSame(date, 'month')) {
            if ((moment__WEBPACK_IMPORTED_MODULE_3__(this.viewDate).isSame(date, 'day') && this.activeDayIsOpen === true) ||
                events.length === 0) {
                this.activeDayIsOpen = false;
            }
            else {
    ...
    CalendarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./calendar.component.html */ "./src/app/pages/apps/calendar/calendar.component.html"),
            styles: [__webpack_require__(/*! ./calendar.component.scss */ "./src/app/pages/apps/calendar/calendar.component.scss")]
        }),
...
/* harmony import */ var _calendar_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./calendar-routing.module */ "./src/app/pages/apps/calendar/calendar-routing.module.ts");
/* harmony import */ var _calendar_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./calendar.component */ "./src/app/pages/apps/calendar/calendar.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CalendarAppModule = /** @class */ (function () {
    ...
    CalendarAppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_calendar_component__WEBPACK_IMPORTED_MODULE_8__["CalendarComponent"], _calendar_edit_calendar_edit_component__WEBPACK_IMPORTED_MODULE_6__["CalendarEditComponent"]],
...
//# sourceMappingURL=app-pages-apps-calendar-calendar-module.js.map